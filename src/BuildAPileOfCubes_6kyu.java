public class BuildAPileOfCubes_6kyu {
...
//findNb(91716553919377) --> -1
    ...
    public static void main(String[] args) {
        System.out.println(findNb(2068792599184742026L));
    }
    ...
    public static long findNb(long m) {
        ...
        while (numberOfCubes < m) {
            n++;
            numberOfCubes += (long) Math.pow(n, 3);
        }

        return m == numberOfCubes ? n : -1;
    }
}
