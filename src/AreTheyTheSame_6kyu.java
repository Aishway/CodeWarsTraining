...
//a or b might be nil or null or None or nothing (except in C++, COBOL, Crystal, D, Dart, Elixir, Fortran, F#, Haskell,
// Nim, OCaml, Pascal, Perl, PowerShell, Prolog, PureScript, R, Racket, Rust, Shell, Swift).
...
//The two arrays have the same size (> 0) given as parameter in function comp.
    ...
    public static boolean comp(int[] a, int[] b) {
        ...
        int[] temporal = Arrays.stream(a).map(e -> e * e).sorted().toArray();
