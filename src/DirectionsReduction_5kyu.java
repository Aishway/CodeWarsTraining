...
public class DirectionsReduction_5kyu {
...
//if you want to translate, please ask before translating.
    ...
    public static String[] dirReduc(String[] arr) {
        ...
        Arrays.stream(arr).forEach(e -> directions.add(e));
        directions.add("empty");
        boolean doWeHaveEnd = false;
        int j = 0;
        ...
        while (!doWeHaveEnd) {
            ...
            for (int i = 0; i < directions.size() - 1; i++) {
                if (Objects.equals(directions.get(i), "WEST") && Objects.equals(directions.get(i + 1), "EAST")
                        || Objects.equals(directions.get(i + 1), "WEST") && Objects.equals(directions.get(i), "EAST")) {
                    directions.remove(i + 1);
                    directions.remove(i);

                } else if (Objects.equals(directions.get(i), "NORTH") && Objects.equals(directions.get(i + 1), "SOUTH")
                        || Objects.equals(directions.get(i), "SOUTH") && Objects.equals(directions.get(i + 1), "NORTH")) {
                    directions.remove(i + 1);
                    directions.remove(i);
                }
            }
        ...
        directions.remove("empty");
        String[] result = directions.toArray(String[]::new);
        return result;
    }
}
